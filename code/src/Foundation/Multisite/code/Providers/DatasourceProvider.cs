namespace Assignment.Foundation.Multisite.Providers
{
    ...
    public class DatasourceProvider : IDatasourceProvider
  {
    ...
    {
      var sourceSettingItem = this.siteSettingsProvider.GetSetting(contextItem, DatasourceSettingsName, name);
    ...
    {
      var settingItem = this.siteSettingsProvider.GetSetting(contextItem, DatasourceSettingsName, name);
