namespace Assignment.Foundation.Dictionary.Repositories
{
    ...
    using Assignment.Foundation.Dictionary.Services;
    ...
    public class DictionaryPhraseRepository : IDictionaryPhraseRepository
    {
        ...
        public string Get([NotNull] string relativePath, string defaultValue = "")
        {
            ...
            if (dictionaryItem != null && !string.IsNullOrEmpty(dictionaryItem.Fields[Templates.DictionaryEntry.Fields.Phrase].Value))
            {
                return dictionaryItem.Fields[Templates.DictionaryEntry.Fields.Phrase].Value;
            }
            return defaultValue;
        }
