namespace Assignment.Foundation.SitecoreExtensions.Extensions
{
    ...
    using Sitecore.Xml;
    using Sitecore;
    using Assignment.Foundation.SitecoreExtensions;
    ...
    public static class RenderingExtensions
  {
    ...
    {
      return MainUtil.GetBool(rendering.Parameters[SitecoreExtensions.Constants.DynamicPlaceholdersLayoutParameters.UseStaticPlaceholderNames], false);
    }
  }
}