namespace Assignment.Foundation.SitecoreExtensions.Attributes
{
    using System;
    using System.Linq;
    ...
    public class ValidateRenderingIdAttribute : ActionMethodSelectorAttribute
    {
        ...
        public override bool IsValidForRequest(ControllerContext controllerContext, MethodInfo methodInfo)
        {
            ...
            string renderingId = httpRequest.Form[FormUniqueid] != null ? httpRequest.Form[FormUniqueid] : string.Empty;

            if (!httpRequest.GetHttpMethodOverride().Equals(HttpVerbs.Post.ToString(), ignoreCase)
                      || string.IsNullOrEmpty(renderingId))
            {
                return true;
            }
